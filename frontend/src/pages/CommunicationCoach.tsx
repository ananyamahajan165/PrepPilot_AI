...
export default function CommunicationCoach() {
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      // Pull the last few sessions for the Improvement Graph. Best-effort —
      // if this fails, the graph component just shows its empty state.
      try {
        ...
        // non-critical — the graph just won't render this time
      }
    } catch (err: any) {
