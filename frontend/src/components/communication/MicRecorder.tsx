      ...
      {status === "idle" && (
        <div className="flex flex-col items-center py-6">
          <button
            ...
            className="w-20 h-20 rounded-full bg-primary hover:bg-primary-hover transition-colors flex items-center justify-center shadow-[0_0_40px_-10px_rgba(242,184,75,0.5)]"
          >
