    ...
    >
      {bars.map((_, i) => {
        ...
        return (
          <div
            key={i}
            className={`w-1.5 rounded-full bg-gradient-to-t from-primary to-teal-400 origin-bottom ${
...
function CorrectionCard() {
  ...
  return (
    <div className={shouldReduceMotion ? "" : "animate-float-slow"}>
      <div className="relative w-full max-w-md rounded-2xl border border-border bg-card/90 backdrop-blur-sm shadow-[0_0_60px_-15px_rgba(242,184,75,0.25)] p-6">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <p className="text-sm text-fg leading-relaxed">
              <span className="text-teal-400 mr-1.5">✓</span>"{example.after}"
            </p>
