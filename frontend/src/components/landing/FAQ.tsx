...
const faqs = [
  ...
  },
  {
    ...
    a: "PrepPilot AI uses Google's Gemini API to analyze sentences, score interview answers, and review resumes — all called securely from the backend, never exposed to the browser.",
  },
  {
    q: "Do I need to install anything?",
    a: "No. PrepPilot AI runs entirely in your browser — no downloads, no extensions.",
  },
  {
